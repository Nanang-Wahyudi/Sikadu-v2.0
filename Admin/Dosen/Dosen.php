    ...
    <table class="table border-secondary mt-4 table-bordered">
        <thead>
            <tr class="d-flex">
                ...
                <th scope="col" class="col-2" style="background-color: lightgray;">NIP</th>
                <th scope="col" class="col-2" style="background-color: lightgray;">Gelar Depan</th>
                <th scope="col" class="col-2" style="background-color: lightgray;">Nama Lengkap</th>
                <th scope="col" class="col-2" style="background-color: lightgray;">Gelar Belakang</th>
        ...
        <?php foreach ($data_dosen as $data) : ?>
            ...
            <tbody>
                <tr class="d-flex">
                    ...
                    <th scope="row" class="col-2"><?= $data["nip"]; ?></th>
                    <td class="col-2"><?= $data["gelar_depan"]; ?></td>
                    <td class="col-2"><?= $data["nama_dosen"]; ?></td>
                    <td class="col-2"><?= $data["gelar_belakang"]; ?></td>
