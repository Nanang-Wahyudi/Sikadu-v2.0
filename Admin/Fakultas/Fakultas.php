...
<div id="table-mahasiswa" class="container table-responsive text-center">
    <table class="table border-secondary mt-4 table-bordered">
        ...
        <?php $no = 1; ?>
        <?php foreach ($data_fakultas as $data) : ?>
            ...
            <tbody>
                <tr class="d-flex">
                    ...
                    <td class="col-3">
                        <a href="?halaman=EditDataFakultas&hal=edit&id=<?= $data["id_fakultas"]; ?>" data-toogle="tooltip" title="Edit" class="btn btn-outline-warning me-2" type="submit"><i class="fa-sharp fa-solid fa-pen-to-square"></i></a>

                        <a href="?halaman=HapusDataFakultas&hal=hapus&id=<?= $data["id_fakultas"]; ?>" onclick="return confirm('Yakin Ingin Menghapus Data Ini ???');" data-toogle="tooltip" title="Hapus" class="btn btn-outline-danger" type="submit"><i class="fa-solid fa-trash"></i></a>
                    </td>
                </tr>
            </tbody>
