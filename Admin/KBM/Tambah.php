            ...
            <div class="card-body bg-light">
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="pertemuan" id="pertemuan" class="form-control" placeholder="--Masukan Jumlah Pertemuan Sekarang--" required autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label for="ruang">Ruang <span class="text-danger">*</span></label>
                        <input type="text" name="ruang" id="ruang" class="form-control" placeholder="--Masukan Nama Ruang Kelas--" required autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label for="jam">Jam Perkuliahan <span class="text-danger">*</span></label>
                        <input type="text" name="jam" id="jam" class="form-control" placeholder="--Masukan Jam Perkuliahan--" required autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label for="kode">Kode <span class="text-danger">*</span></label>
                        <input type="number" name="kode" id="kode" class="form-control" placeholder="--Masukan Kode Perkuliahan--" required autocomplete="off">
                    </div>
